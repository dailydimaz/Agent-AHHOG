...
A Claude Code skill that replicates Ahrefs' Agent and extends it with conversion analytics: a marketing AI agent that turns **Ahrefs** data (search, links, rankings, AI visibility) and **PostHog** data (on-site behavior, funnels, conversions, retention) into finished marketing artifacts.
...
- Delivers finished artifacts — markdown reports, CSV exports, dashboards — saved to disk

It ships with:

- **20+ single-source Ahrefs workflows** (content gap, cannibalization, content decay, site audit triage, backlink analysis, broken link building, link intersect, unlinked mentions, SERP features, Brand Radar visibility, share of voice, AI-cited pages, competitor overview, keyword research, programmatic SEO, web analytics deep dive, rank tracker report, E-E-A-T audit, migration plan, internal link map)
...
6. Optional: Notion, Slack, GitHub, Linear, Google Drive MCPs for output destinations.
...
PostHog writes are tiered: creating dashboards, cohorts, draft experiments, surveys, and annotations happens without friction. Changes to live feature flags or experiments, and any deletion, are confirmed with you first.
...
└── references/                       # Loaded on demand
    ...
    ├── workflows.md                  # 20 single-source Ahrefs workflow recipes
...
Agent AHHOG is an independent skill inspired by the *capabilities* of Ahrefs (https://ahrefs.com), extended with PostHog product analytics. It is not affiliated with or endorsed by Ahrefs, PostHog, Letaido, or Anthropic. It uses the official Ahrefs and PostHog MCP servers per each provider's terms of use.
